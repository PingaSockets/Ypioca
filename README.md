# Ypioca - Typescript WhatsApp Web API
...
Ypioca and its maintainers cannot be held liable for misuse of this application, as stated in the [MIT license](https://github.com/PingaSockets/Ypioca/blob/master/LICENSE).
